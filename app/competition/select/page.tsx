...
export default function CompetitionSelectPage() {
  ...
  const { competitions, loading: competitionsLoading, error: competitionsError, fetchCompetitions } = useCompetition();
  const { register, loading: registrationLoading, error: registrationError } = useRegistration();
  ...
  const handleRegister = async () => {
    ...
    const registration = await register({ competitionId: selectedCompetition.id });
    if (registration) {
