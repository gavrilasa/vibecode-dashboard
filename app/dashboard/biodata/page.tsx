...
import { User, Mail, Phone, MapPin, GraduationCap, Edit, FileText } from 'lucide-react';
      ...
      <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold">{biodata.university}</p>
                  </div>
                </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-900 dark:text-white">{biodata.emergencyContact}</p>
            </CardContent>
          </Card>
        </div>
